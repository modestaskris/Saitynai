...
<template>
  <div :class="divStyle" @click="(e) => navigate(e)">
    ...
    <div>
      <div class="flex justify-end">
        ...
        @editModelPressed="editModelClicked" :model-name="name" :model-type="modelType" />
...
export default defineComponent({
  ...
  methods: {
    ...
    navigate(e: any) {
      if (this.isSong || this.modalIsActive) { // no navigation from song component
        return;
      }
